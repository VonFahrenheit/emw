...
;	Adept Shaman	- $32B808
	...
	!AggroRexIFrames	= $35B0,x	; Extra prop 2
...
.MAIN		PHB : PHK : PLB
		...
		LDA $34D0,x			;\ No animation during hit stun
		BEQ $03 : DEC !SpriteAnimTimer		;/
...
.INIT		PHB : PHK : PLB
		...
		LDA !GFX_status+$0C		;\ Set base tile
		STA !ClaimedGFX			;/
...
.GetMain	JSR REX_BEHAVIOUR
	...
	-	LDA ($06),y			;\
		...
		SEP #$20			; > A 8-bit
		JSR LOAD_PSUEDO_DYNAMIC		; > Upload tilemap
		PLB
		RTL
...
.Slow		LDA !RexAI			;\
		...
		PEA.w .SpeedReturn-1		;\ Accelerate
		JMP REX_CHASE_SPEED		;/
...
.NoSpinKill	LDA !AggroRexIFrames : BEQ +	; > No damage during I-frames
	...
	+	LDA !RexAI			;\
		AND #$04 : BEQ +		; | Brutes get some I-frames
