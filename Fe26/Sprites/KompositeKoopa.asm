KompositeKoopa:
	...
	INIT:
		...
		LDA !GFX_status+$11 : STA !ClaimedGFX
		INC $3320,x
		LDA !Difficulty			;\
		AND #$03			; | Starting HP
		CLC : ADC #$03			; |
...
;
	...
	dw $0024
	db $2A,$D8,$D0,$AA	; head
	db $2A,$E0,$D0,$AB	; torso
	db $2A,$EA,$D8,$A4	; tile 1
	db $2A,$E2,$E1,$A4	; tile 2
	db $2A,$E0,$ED,$A4	; tile 3
	db $2A,$E2,$F9,$A4	; tile 4
	db $2A,$EA,$00,$A4	; tile 5
	db $2A,$F5,$02,$A4	; tile 6
	db $2A,$00,$00,$A4	; base

	.Frame2
	dw $0024
	db $2A,$AB,$E4,$AA	; head
	db $2A,$B3,$E4,$AB	; torso
	db $2A,$BE,$E8,$A4	; tile 1
	db $2A,$C9,$EC,$A4	; tile 2
	db $2A,$D4,$F0,$A4	; tile 3
	db $2A,$DF,$F4,$A4	; tile 4
	db $2A,$EA,$F8,$A4	; tile 5
	db $2A,$F5,$FC,$A4	; tile 6
	db $2A,$00,$00,$A4	; base

	.Frame3
	dw $0024
	db $2A,$BC,$00,$AA	; head
	db $2A,$C4,$00,$AB	; torso
	db $2A,$D0,$FE,$A4	; tile 1
	db $2A,$D4,$F3,$A4	; tile 2
	db $2A,$DC,$EB,$A4	; tile 3
	db $2A,$E8,$EB,$A4	; tile 4
	db $2A,$F0,$F3,$A4	; tile 5
	db $2A,$F4,$FE,$A4	; tile 6
	db $2A,$00,$00,$A4	; base
	...
	dw $0024
	db $2A,$F8,$00,$AA	; head
	db $2A,$00,$00,$AB	; torso
	db $2A,$00,$00,$A4	; tile 1
	db $2A,$00,$00,$A4	; tile 2
	db $2A,$00,$00,$A4	; tile 3
	db $2A,$00,$00,$A4	; tile 4
	db $2A,$00,$00,$A4	; tile 5
	db $2A,$00,$00,$A4	; tile 6
	db $2A,$00,$00,$A4	; base
