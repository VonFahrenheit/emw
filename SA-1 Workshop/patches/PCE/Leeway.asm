...
;
	...
	+	STZ !P2ClimbTop				;/
		...
		AND #$03
		TAX
		LDA CONTROLS_XSpeed,x : STA !P2XSpeed
...
; JSR-ables
	...
	dw $FFE1,$FFDE : db $2D,$38		; Left
	dw $0002,$FFDE : db $2D,$38		; Right
	...
	AIRSLASH:
	.0					; Start at sword coords + 3;-20 (sword, not lil' cut tile)
	dw $FFE3,$FFDC : db $2D,$38		; Left
	dw $0000,$FFDC : db $2D,$38		; Right
	.1					; Start at sword coords + 5;8
