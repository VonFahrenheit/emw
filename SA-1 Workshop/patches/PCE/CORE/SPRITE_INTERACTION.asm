...
; Interaction 09 is for Bullet Bill (#$1C), Lakitus (#$1E and #$4B), Magikoopa (#$1F), Ninji (#$51),
...
SPRITE_INTERACTION:
	...
	++	STA $F6				;/
		...
		.Loop
		LDA $3230,x			;\ Loop if sprite is in an invalid state
		CMP #$08 : BCC .End		;/
		LDA !CurrentPlayer		;\
		BNE +				; |
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	INT_0A:
		LDX $7695
		LDA #$08 : JSR CompareY
		BCC INT_0D_Side			; > Solid on the side
...
.Aggro		LDA $35B0,x : BNE .Invinc
		LDA #$40 : STA $35B0,x		; Set invinc
		LDA $BE,x
		INC A
		STA $BE,x
		CMP #$03
...
INTERACTION_TABLE:	db $01,$01,$01,$01,$02,$02,$02,$02,$03,$03,$03,$03,$03,$04,$00,$05	;| 00X
			db $06,$02,$00,$07,$07,$08,$08,$00,$08,$00,$00,$07,$09,$07,$09,$09	;| 01X
			...
			db $00,$09,$09,$09,$1A,$1A,$1A,$1A,$1A,$00,$00,$11,$00,$00,$00,$00	;| 07X
