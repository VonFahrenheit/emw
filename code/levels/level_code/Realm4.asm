...
level10:
	...
	++	JML GrindPtr_HandleGrind

	+	PEA.w GrindPtr_HandleGrind-1
		LDA !BossData+0
		ASL A
		TAX
		JMP (GrindPtr,x)
	...
	++	LDA #$0002 : STA $41		; window 1 enable
		LDA #$0004 : TRB !HDMA		; end parallax at this point
		LDA #$2601 : STA $4330
		STZ $4334
		...
		XBA
		STA $0404
		LDA #$0008 : TSB !HDMA		; different channel so the platform won't disappear for 1 frame
...
level13:
	...
	.Init
		...
		LDA #$04 : STA !MainScreen		;\ BG3 on main screen, everything else on sub
		...
		INC $14 : JSL level13_HDMA
		DEC $14 : JSL level13_HDMA
		RTL
...
; !BigRAM+$16 = Cx (closest chunk height on screen)
	...
	; +0+1
		...
		LDA $14					; |
		AND #$0001				; |
		BEQ $03 : LDA #$0010			; > double buffer: 0 or 10
		TAX					; |
		LDA $1A					; |
		STA $0D00,x				; |
		STA $0D0C,x				; |
