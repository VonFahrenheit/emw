...
.16	dw $0001,$0002,$0004,$0008,$0010,$0020,$0040,$0080
	...
	db $02,$01
		...
		STA !MarioYSpeed
		..return
		LDA !MarioHasFire : BNE +			; check if mario has a fire charge
		LDA #$01 : STA !MarioHasFire			;\
		LDA !CurrentMario : BEQ +			; |
		PHY						; |
		LDY #$00					; |
	...
	..No	JML MarioCapeReturn
		...
		AND #$40 : BNE ..Fire
	..No	JML $00D0AD
	..Fire	LDA !MarioHasFire : BEQ ..No			; only allow if mario has a fire charge
		JML $00D085


		.TacticalFire
		STZ !MarioHasFire				; consume mario's fire charge
		LDA !MarioUpgrades
		AND #$08 : BEQ ..30
		LDA $15
		AND #$08 : BEQ ..30
	...
	;	BEQ $02 : LDY.b #!palset_mario_fire		;/
		LDA !MarioHasFire				;\ fire palette if mario has palette charge
		BEQ $02 : LDY.b #!palset_mario_fire		;/
	;	LDA $19						;\
