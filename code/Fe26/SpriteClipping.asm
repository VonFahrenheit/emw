...
; 06 - block (16x16, tile-aligned)
; ----
; 14 - sight box (16x1024, up/down)
; 15 - sight box (256x224, both directions)
...
org $03B56C
SpriteClippingX:
	dw $0002,$0002,$FFFC,$0005,$0000,$FFFE,$0000,$AAAA
	dw $AAAA,$AAAA,$AAAA,$AAAA,$AAAA,$AAAA,$AAAA,$AAAA
	dw $AAAA,$AAAA,$AAAA,$AAAA,$0000,$FF80,$FFC8,$FFC8
	dw $0000,$FFC0,$0000,$FF80,$FFB8,$FF88
SpriteClippingY:
	dw $0003,$FFF8,$FFF8,$0002,$0000,$FFFE,$0000,$AAAA
	dw $AAAA,$AAAA,$AAAA,$AAAA,$AAAA,$AAAA,$AAAA,$AAAA
	dw $AAAA,$AAAA,$AAAA,$AAAA,$FE00,$FFA0,$FFC8,$FFD0
	dw $FFE8,$FFE8,$FFE8,$FFE8,$FFD0,$FFD0
SpriteClippingW:
	dw $000C,$000C,$0018,$0006,$0020,$0014,$0010,$AAAA
	dw $AAAA,$AAAA,$AAAA,$AAAA,$AAAA,$AAAA,$AAAA,$AAAA
	dw $AAAA,$AAAA,$AAAA,$AAAA,$0010,$0100,$0080,$0080
	dw $0040,$0040,$0080,$0080,$00A0,$0100
SpriteClippingH:
	dw $000A,$0013,$0018,$0006,$0020,$0012,$0010,$AAAA
	dw $AAAA,$AAAA,$AAAA,$AAAA,$AAAA,$AAAA,$AAAA,$AAAA
	dw $AAAA,$AAAA,$AAAA,$AAAA,$0400,$00C0,$0080,$0040
...
org $03B65C
	CheckContact:						; $03B662 CheckContact
		...
		LDA $E8						;\
		CLC : ADC $EC					; | Bx + Bw - Ax
		CMP $E0 : BMI .NoContact			;/
		LDA $E2						;\
		CLC : ADC $E6					; | Ay + Ah - By
		CMP $EA : BMI .NoContact			;/
		LDA $EA						;\
		CLC : ADC $EE					; | By + Bh - Ay
		CMP $E2 : BMI .NoContact			;/
		.Contact					;\
		SEC						; | contact: set c (and return with A 8-bit)
		SEP #$20					;/
		RTL						; return
		.NoContact					;\ A 8-bit
		CLC						; | no contact: clear c (and return with A 8-bit)
		SEP #$20					;/
		RTL						; return
