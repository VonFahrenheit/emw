	...
	INIT:
		...
		LDA !SpriteTweaker4,x : AND #$07			;\ all resistances except star (keep weight)
		ORA #$D8 : STA !SpriteTweaker4,x			;/
	...
	.Graphics
		...
		..draw							;/
		REP #$20						;\
		LDA.w #ANIM : JSL UNPACK_ANIM				; | animate + draw
