	...
	INIT:
		...
		LDA !SpriteTweaker6,x : STA !KoopaTweaker6Backup,x		; back up tweaker 6 settings
	...
	MAIN:
		...
		..small
		REP #$20
		LDA.w #ANIM_Shelless : BRA ..update
		..kicker
		REP #$20
		LDA.w #ANIM_Kicker : BRA ..update
		..shell
		REP #$20
		LDA.w #ANIM_Shell : BRA ..update
		..big
		REP #$20
		LDA.w #ANIM_Koopa : BRA ..update
		..dancer
		REP #$20
		LDA.w #ANIM_Dancer
		..update
		JSL AUTO_ANIM
		LDA !SpriteAnimIndex,x : BPL ..done
		STZ !SpriteStatus,x
		RTS
		..done
	...
	Physics:
		...
		JSL SUB_HORZ_POS
		TYA : STA !SpriteDir,x
		LDA !KoopaTweaker6Backup,x : STA !SpriteTweaker6,x		; reload tweaker 6
	...
	Animation:
		...
		..processanim
		REP #$20
		LDA.w #ANIM_Dancer : JSL UNPACK_ANIM
		..checkshell
		LDA !SpriteAnimIndex,x
		CMP #$05 : BEQ ..shell
		CMP #$09 : BCC ..done
	...
	Parakoopa:
		REP #$20
		LDA.w #ANIM_Koopa : JSL AUTO_ANIM
		LDA !SpriteNum,x
		AND #$07
		ASL A
		CMP.b #.Ptr_end-.Ptr
...
++++	INC !WingTimer,x
	...
	.Graphics
		REP #$20
		LDA.w #ANIM_Koopa : JSL UNPACK_ANIM
		JSL LOAD_PSUEDO_DYNAMIC
