...
;	LDA #$02 : STA !LavaLordPhase
	...
	.Volley	AND #$0F : BNE .R
		...
		LDY #$07
	-	LDA !ExSpriteNum,y : BEQ .SpawnVolley
		DEY : BPL -
		RTS
		...
		LDA $00 : STA !ExSpriteXPosLo,y
		LDA $01 : STA !ExSpriteXPosHi,y
		RTS
	...
	-	LDA !ExSpriteNum,y
		...
		LDA !ExSpriteTimer,y
		CMP #$FF : BNE +
		LDA #$32 : STA !ExSpriteTimer,y		; set life timer
	...
	.AuraTM
	dw $0058
	db $2F,$D8,$D8,$C0	; left arm
	db $2F,$E8,$D8,$C2
	db $2F,$D8,$E8,$E0
	db $2F,$E8,$E8,$E2
	db $2F,$E8,$F8,$CC	; left armpit
	db $2F,$F8,$D8,$C4	; head
	db $2F,$08,$D8,$C6
	db $2F,$F8,$E8,$E4
	db $2F,$08,$E8,$E6
	db $2F,$18,$D8,$C8	; right arm
	db $2F,$28,$D8,$CA
	db $2F,$18,$E8,$E8
	db $2F,$28,$E8,$EA
	db $2F,$18,$F8,$EC	; right armpit
	db $2F,$F8,$F8,$84	; upper body
	db $2F,$08,$F8,$86
	db $2F,$F8,$08,$A4
	db $2F,$08,$08,$A6
	db $2F,$F8,$18,$88	; lower body
	db $2F,$08,$18,$8A
	db $2F,$F8,$28,$A8
	db $2F,$08,$28,$AA
