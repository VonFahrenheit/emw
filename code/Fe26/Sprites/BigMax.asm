BigMax:
	...
	.New	LDA Anim+3,y : STA !SpriteAnimIndex
		...
		LDA #$4C : BRA .Store			; always render first frame of charge during roar/jump
	.Frame	LDA Anim+0,y
	...
	-	LDA #$09
		...
		STA !ExSpriteNum+4,y
		LDA #$40
		STA !ExSpriteTimer+0,y
		STA !ExSpriteTimer+4,y
		LDA #$29
		STA !ExSpriteBehindBG1+0,y
		STA !ExSpriteBehindBG1+4,y
		LDA $00 : STA !ExSpriteXPosLo+0,y : STA !ExSpriteXPosLo+4,y
		LDA $01 : STA !ExSpriteXPosHi+0,y : STA !ExSpriteXPosHi+4,y
		LDA $02 : STA !ExSpriteYPosLo+0,y
		CLC : ADC #$10
		STA !ExSpriteYPosLo+4,y
		LDA $03 : STA !ExSpriteYPosHi+0,y
		ADC #$00
		STA !ExSpriteYPosHi+4,y
		LDA $04 : STA !ExSpriteMisc+0,y
		CLC : ADC #$10
		STA !ExSpriteMisc+4,y
		INC $04
		LDA .XSpeed,y
		STA !ExSpriteXSpeed+0,y
		STA !ExSpriteXSpeed+4,y

		LDA #$E0 : STA !ExSpriteYSpeed+0,y
		LDA #$E8 : STA !ExSpriteYSpeed+4,y
