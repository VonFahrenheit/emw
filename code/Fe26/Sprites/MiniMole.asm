MiniMole:
	...
	INIT:
		...
		STZ !MiniMoleClingHP
		LDA !MiniMoleState : BNE .NoWalk		;\
		LDA !ExtraBits,x				; | extra bit clear to walk, set to burrow
		AND #$04 : BNE .NoWalk				; | (if sprite was spawned by another, ignore extra bit selection)
