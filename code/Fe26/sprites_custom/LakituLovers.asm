...
; The female Lakitu's position is determined by the GFX routine and an additional hitbox
	...
	-	JSR .HitBoxBase
		...
		.Shared
		STA $0C
		LDY.b #!File_LakituLovers : JSL UpdateGFX_NoOffset
		LDA.w #!BigRAM : STA $04
		SEP #$20
		LDA !InvincTimer
		AND #$02 : BNE .Invis
	...
	++	STA $1E
		...
		STA $EC : STZ $ED
		STA $EE : STZ $EF
		JSL PlayerContact : BCS .Interact_Boom
		RTS
...
;
	...
	;	JSL !GetSpriteSlot
		...
		LDA #$15 : STA $3200,y				;\ sprite number and status
		LDA #$01 : STA $3230,y				;/
...
;
	...
	.GoodY	SEP #$20
		...
		ORA #$80					; |
		STA !Ex_Data1,y					; |
		LDA $0B : STA !Ex_Data3,y			; |
		LDA #$08 : STA !Ex_Data2,y			; |
		LDA !SpinyMemory+$8 : STA !Ex_XLo,y		; |
		LDA !SpinyMemory+$9 : STA !Ex_XHi,y		; |
		LDA !SpinyMemory+$A : STA !Ex_YLo,y		; |
		LDA !SpinyMemory+$B : STA !Ex_YHi,y		;/
...
; Load $02 with property "EOR" bits
...
; Anim is uploaded to !BigRAM and modified during phase processing
	...
	; Idle animation
		...
		db $39,$F4,$08,$69
		db $39,$04,$08,$6B
		db $39,$0C,$00,$5A	; this one doesn't need the ($08;$08)-tile
