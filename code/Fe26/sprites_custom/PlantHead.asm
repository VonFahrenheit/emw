...
PlantHead:
	...
	namespace PlantHead
		...
		!PlantHeadChew			= $3280
		!PlantHeadPulseTimer		= $3290		; timer for pulse animation
...
; +$6000 for pulse frame 2
	...
	.HandleAnim
		...
		..new
		LDA ANIM+$03,y : STA !SpriteAnimIndex,x
		ASL #2
		TAY
		LDA #$00
		..same
...
;	- 0F	15/16 clockwise
	...
	--	DEY : BPL -
		...
		.Spawn
		LDA #!VolcanoLotusFire_Num : STA !Ex_Num,y
