...
;	LDA #$02 : STA !LavaLordPhase
	...
	-	LDA !Ex_Num,y : BEQ .SpawnVolley
		...
		.SpawnVolley
		LDA #!Malleable_Num : STA !Ex_Num,y	; spawn flames that target players
	...
	-	LDA !Ex_Num,y
		...
		LDA #!prt_smoke16x16 : STA !Ex_Data1,y	; | turn to smoke puff on last frame
		LDA #$00				; |
		STA !Ex_XSpeed,y			; |
		STA !Ex_YSpeed,y			; |
		BRA +					;/
