...
Monkey:
	...
	.P1	LDA #$01
		BRA .PCE
	.P2	LDA #$02
	.PCE	JSL PlayerContact

		.Check
		REP #$20
		LDA.w #.SightBox : JSL LOAD_HITBOX
		JSL CheckContact : BCC .KeepWaiting
	...
	Conga:
		REP #$20
		LDA.w #.Hitbox : JSL LOAD_HITBOX_E0
	...
	.check	LDA !ExtraBits,y
		AND.b #!CustomBit
		BEQ .next
		LDA $3200,y			; if it's the same type of sprite, check contact
		CMP $3200,x : BNE .next
