...
endmacro
	...
	; HDMA update
		LDA !MsgTrigger : BNE +			; > let message boxes use indirect mode
		LDX !GameMode				;\
	...
	; misc registers
		...
		; note: 210B (BG1/BG2 chr address) and 210A (BG4 tilemap address) are not updated here
		;	they have to be set at level/overworld load and then not changed
		LDX #$2109 : TXS			; S = $2109
	...
	; finish v-blank
		...
		LDA !420C : STA $420C			; this is double-mirrored to prevent oddities on lag frames
