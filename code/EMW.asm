...
if !LockROM = 0
	...
	; remove lunar magic info
	org $0FF0A0
	padbyte $00 : pad $0FF100
	warnpc $0FF100

	; remove i love fish comment
	org $0FF120
	padbyte $00 : pad $0FF140
	warnpc $0FF140
	...
	org $00FFD5
	db $23		; map mode: 
	db $35		; cartridge type: 
	db $0C		; ROM size: 4 MiB
	db $07		; SRAM size: 128 KiB
	db $01		; region: USA
	db $01		; developer ID: 01
	db !Version	; version number: 1.0
	warnpc $00FFDC
...
; 00E864	JML $00806B		; return to CORE loop
	...
	-	BIT $4212 : BMI - : BVS -		; | always enable NMI + IRQ here (IRQ will know during which game modes to display status bar)
		...
		LDA #$80 : STA $2200			;/
		JSR.w MPU_Light				; have SNES run shading operation
...
;=========;
	...
	incsrc "CodeBase/EffectLibrary.asm"

	incsrc "CodeBase/5bpp.asm"
	incsrc "CodeBase/Transform_GFX.asm"
	incsrc "CodeBase/BeatLevel.asm"



	; remember to remove this after object loader rewrite
	incsrc "CodeBase/TranslateOldExitNumber.asm"
...
;=========;
	...
	incsrc "Engine/InitialTilemaps.asm"
...
;	incsrc "GameModeLevelLoad.asm"
	incsrc "LoadLevel.asm"
	incsrc "GameMode14.asm"
	incsrc "levels/LevelData.asm"
	incsrc "levels/LevelPointers.asm"

namespace LevelCode
	incsrc "levels/level_code/LevelSubRoutines.asm"
	incsrc "levels/level_code/WeatherHandlers.asm"
	print "Realm 5 code inserted at $", pc, "."
	incsrc "levels/level_code/Realm5.asm"
	print "Realm 6 code inserted at $", pc, "."
	incsrc "levels/level_code/Realm6.asm"
	print "Realm 7 code inserted at $", pc, "."
	incsrc "levels/level_code/Realm7.asm"
	print "Realm 8 code inserted at $", pc, "."
	incsrc "levels/level_code/Realm8.asm"
	print "Bank $1A level code ends at $", pc, "."

	org $1B8000
	print "Unsorted code inserted at $", pc, "."
	incsrc "levels/level_code/Unsorted.asm"
	print "Bank $1B code ends at $", pc, "."

	org $1C8008
	print "Realm 1 code inserted at $", pc, "."
	incsrc "levels/level_code/Realm1.asm"
	print "Realm 2 code inserted at $", pc, "."
	incsrc "levels/level_code/Realm2.asm"
	print "Realm 3 code inserted at $", pc, "."
	incsrc "levels/level_code/Realm3.asm"
	print "Realm 4 code inserted at $", pc, "."
	incsrc "levels/level_code/Realm4.asm"
