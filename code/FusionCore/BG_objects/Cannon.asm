...
;	2/1	which players are currently entering cannon (bits 02/01)
	...
	Cannon:
		...
		AND #$00FF : STA.l !BigRAM			; > save this here for interaction check
		BNE .Graphics					; | see which code to run
		JMP .Interact					;/
		...
		LDY !BG_object_Y,x : STA $98			; |
		PHX						; |
		SEP #$20					; |
		PHB : PHK : PLB					; |
		JSL GetMap16_Tile				; |
		PLB						; |
		REP #$30					; | get palette (---CCC-- bits)
		PLX						; |
		LDA $03						; |
