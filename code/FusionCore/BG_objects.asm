...
; !BigRAM+0 = timer
	...
	.Player1
		...
		LDY #$04					; > default size of player = medium
		LDA !P2XSpeed-$80				; |
		JSR .AdjustSize					; |
		REP #$20					; |
	...
	.Sprites
		...
		LDA !SpriteTweaker4,x				; | get sprite weight
		AND #$07 : BEQ ..next				; > if weight = 0, interaction is invalid
		TAY						;/
		LDA !SpriteXSpeed,x : BEQ ..next		;\ adjust based on speed
		JSR .AdjustSize					;/
		REP #$20					;\
