...
;
; input:
;	A = color balance between palette and cache, used for mixers only
;		00-1F for RGB
;		00-FF for HSL
...
; during the process, Y will index the RGB palette and X will index the HSL palette
	...
	++	PLY
		...
		LDA !colormix+2 : STA !CGRAMtable+$05,y		; dest CGRAM
		REP #$20
		AND #$00FF
		PHA
		ASL A
		...
		LDA !colormix : STA !CGRAMtable+$00,y		; upload size
		PLA
		LSR #4
		TAX
		LDA !colormix
